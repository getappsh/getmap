...
import { DELIVERY, DEPLOY, DEVICE, DEVICES_CATALOG_ID, DEVICES_PLATFORM, DEVICES_PROJECT_ID, DISCOVER, INSTALLED, PREPARED_DELIVERY, PREPARE_DELIVERY, PROJECT_MANAGEMENT, UPDATE_DEPLOY_STATUS, UPDATE_DOWNLOAD_STATUS } from "@app/root/api/src/utils/paths";
import { OfferingResponseDto } from "@app/common/dto/offering";
import { PrepareDeliveryReqDto, PrepareDeliveryResDto, PrepareStatusEnum } from "@app/common/dto/delivery";
import { DeliveryStatusEnum, DeployStatusEnum, ItemTypeEnum } from "@app/common/database/entities";
